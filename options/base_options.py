...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--floroot', required=True, help='real flow.flo path')
        parser.add_argument('--mbroot', required=True, help='real flow.flo path')
        parser.add_argument('--occroot', required=True, help='real flow.flo path')
        ...
        parser.add_argument('--input_nc', type=int, default=128 , help='# of input image channels: 3 for RGB and 1 for grayscale')  #192 fo occ  No occ
        parser.add_argument('--output_nc', type=int, default=2, help='# of output image channels: 3 for RGB and 1 for grayscale')
        parser.add_argument('--output_nc_add', type=int, default=1, help='# of output image channels: 3 for RGB and 1 for grayscale')
        ...
        parser.add_argument('--load_size', type=int, default=286, help='scale images to this size')#286
